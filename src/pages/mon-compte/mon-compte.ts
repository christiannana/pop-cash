...
onCrediter(){
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: data => {
            ...
            this.service.onSolde(this.phone, data.password).subscribe(
              res => {
                console.log(res);
                if (res[0] == true) {
    ...
    const prompt = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: data => {
            this.controle.LoadinService();
            this.service.onRetrait2(this.phone, data.password).subscribe(
             (res: any) => {
                console.log(res);
                if (res.code == true) {
  ...
  onValidateRetrait(){
    this.controle.LoadinService();
    this.service.onRetrait(this.phone).subscribe((res: any)=>{
      console.log(res)
      if(res.status == true){
